...
class Packets:
    ...
    def main():
        ...
        #we already know that the header is in the first 8 bytes
        ...
        #we specified
        seq, ack, flags, win = Packets.parse_header (header_from_msg)
        ...
        seq, ack, flags, win = Packets.parse_header (msg) #it's an ack message with only the header
